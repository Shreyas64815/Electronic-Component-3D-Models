...
<p align="center">
  <img src="preview.png" alt="5mm RGB LED Preview" width="600">
</p>
...
An accurate 3D CAD model of a **5mm RGB LED**, created in **Autodesk Fusion 360** using dimensions referenced from manufacturer documentation and available technical references.
...
| Property | Value |
|----------|-------|
| Component | 5mm RGB LED |
| LED Type | Through-Hole RGB LED |
| Lens Diameter | 5 mm |
| Terminal Count | 4 |
...
| File | Description |
|------|-------------|
| `RGBLED5mm_SS.step` | Standard CAD model compatible with most CAD software |
| `RGBLED5mm_SS.stl` | Mesh model suitable for 3D printing and visualization |
